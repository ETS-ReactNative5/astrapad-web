...
const ConnectButton = ({ provider }) => {
 ...
 <ModalHeader toggle={connectModalToggle}><span className="ml-1 roititle font-weight-bold">Connect Wallet</span></ModalHeader>
   ...
   <div className="mt-2">
                 ...
                 <div className="connectbtn mb-2 p-2 pl-3" onClick={() => connectWallet('injected')}><span className="float-left">MetaMask</span>  </div>                 
                 <div className="connectbtn mb-2 p-2 pl-3" onClick={() => connectWallet('injected')}><span className="float-left">TrustWallet</span>  </div>                 
                 <div className="connectbtn mb-2 p-2 pl-3" onClick={() => connectWallet('injected')}><span className="float-left">MathWallet</span> </div>                 
                 <div className="connectbtn mb-2 p-2 pl-3" onClick={() => connectWallet('injected')}><span className="float-left">TokenPocket</span>  </div>                 
                 <div className="connectbtn mb-2 p-2 pl-3" onClick={() => connectWallet('walletconnect')}><span className="float-left">Wallet Connect</span>  </div>                 
                 <div className="connectbtn mb-2 p-2 pl-3" onClick={() => connectWallet('bsc')}><span className="float-left">Binance Smart Chain Wallet</span>  </div>                 
                 <div className="connectbtn mb-2 p-2 pl-3" onClick={() => connectWallet('injected')}><span className="float-left">Safepal Wallet</span>  </div>                 
                 <div className="connectbtn mb-2 p-2 pl-3" onClick={() => connectWallet('injected')}><span className="float-left">Coin98 Wallet</span>  </div>                 
